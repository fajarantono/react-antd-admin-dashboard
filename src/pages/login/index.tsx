...
import {Layout, Row, Col, Space, Form, Input, Button, Grid, Typography} from 'antd';
...
import {authLoginThunk} from '@/store/slices/user';
      ...
      <Content className={classes.content}>
        <Row gutter={[{xs: 0, sm: 0, lg: 120}, 0]}>
          ...
          <Col xs={24} sm={24} lg={12}>
            <div className={classes.loginWrapper} style={{minWidth: !screens.lg ? '70vw' : '20vw'}}>
