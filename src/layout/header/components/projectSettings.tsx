...
import {useAppDispatch, useAppSelector, globalSlice} from '@/store';
...
export default function ProjectSettings() {
  ...
  return (
    <>
      <div role="menuitem" tabIndex={-1} onClick={() => setIsOpen(true)} onKeyDown={() => {}}>
      ...
      <Drawer
        ...
        <div
          ...
          <Switch
            ...
            checkedChildren={
              <svg data-v-5689ef45="" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path
